...
if __name__ == '__main__':
    ...
    tp = TokenPassingRecovery(agents, dimensions, obstacles, non_task_endpoints, simulation, a_star_max_iter=4000, k=2,
                              replan_every_k_delays=False, pd=0.2, p_max=0.8, p_iter=1, new_recovery=True)
