...
from Simulation.Visualization.visualize import Animation
import subprocess
import sys
...
if __name__ == '__main__':
    ...
    tp = TokenPassingRecovery(agents, dimensions, obstacles, non_task_endpoints, simulation, a_star_max_iter=args.a_star_max_iter, k=args.k,
                              replan_every_k_delays=False, pd=args.pd, p_max=args.p, p_iter=args.p_iter, new_recovery=True)
    ...
    create = [sys.executable, '-m', 'Simulation.Visualization.visualize', '-slow_factor', str(args.slow_factor)]
